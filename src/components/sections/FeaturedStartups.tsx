    ...
    <section className="section bg-white">
      <div className="container-cauris">
        <SectionTitle
          ...
          title="Les startups qui façonnent l'Afrique de demain"
          description="Une sélection des entreprises accompagnées par CAURIS DIGITAL."
        />

        <div className="mt-14 grid grid-cols-2 md:grid-cols-3 gap-4 lg:gap-6">
          {FEATURED_STARTUPS.map((s, i) => (
            <Reveal key={s.name} delay={i * 60}>
              <article className="card group p-6 border border-gray-100 h-full">
